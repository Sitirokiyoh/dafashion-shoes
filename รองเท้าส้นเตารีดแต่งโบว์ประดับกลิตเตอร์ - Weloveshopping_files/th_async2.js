...
if(VisitorT==null)VisitorT=0;truehitsurl=truehitsurl.replace(/&/g,"%26").replace(/\"/g,"%22").replace(/\'/g,"%27").replace(/\</g,"%3c").replace(/\>/g,"%3e").replace(/\:/g,"%3a");arg="&bv="+VisitorT+"&rf="+rf+"&web="+hash+collector()+_narg+"&truehitspage="+__th_page+"&truehitsurl="+truehitsurl;}}catch(e){arg="";}
__thflag=1;hash='';
if(arg.length>0){
...
if( truehits_div != null ){truehits_div.innerHTML = "<a href='http://truehits.net/"+_ctg+"' target='_blank'>"+"<img src='http://"+_hsv+'/'+_ht+'?hc='+_hc+arg+"' width=14 height=17 "+"alt='Thailand Web Stat' border=0></a>";
}else{truehits_div = window.document.createElement("DIV");truehits_div.setAttribute('id','truehits_div');truehits_div.innerHTML = "<a href='http://truehits.net/"+_ctg+"' target='_blank'>"+"<img src='http://"+_hsv+'/'+_ht+'?hc='+_hc+arg+"' width=14 height=17 "+"alt='Thailand Web Stat' border=0></a>";window.document.body.appendChild( truehits_div );}
arg="";
}
